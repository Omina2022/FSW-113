...
function printCalendar(){
   let years = document.getElementById("yearFind").value 
    console.log(years)
    let month1 =document.getElementById("monthSelector").value
    console.log(month1)
const today = new Date (`${month1}/1/${years}`)
console.log(today)
...
const yearFind=document.getElementById("yearFind")
...
document.getElementById("GoButton").addEventListener('click', printCalendar )
// document.getElementById("").innerHTML=today